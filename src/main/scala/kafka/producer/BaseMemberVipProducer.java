...
//kafka-topics --zookeeper node47:2181 --create --replication-factor 2 -partitions 1 --topic test_vip
        public static void main(String[] args) {
            ...
            for (int i = 0; i < 5; i++) {
                ...
                producer.send(new ProducerRecord<String, String>("test_vip", jsonString));
            }
            producer.flush();
            producer.close();
    }
