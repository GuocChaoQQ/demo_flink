...
public class BaseMemberKafkaProducer {
    ...
    public static void main(String[] args) {
        //kafka-topics --zookeeper node47:2181 --create --replication-factor 2 -partitions 1 --topic test_member
        //kafka-console-consumer --bootstrap-server node123:9092 --topic test_member --group test  --from-beginning
        ...
        for (int i = 0; i < 1000000; i++) {
            ...
            producer.send(new ProducerRecord<String, String>("test_member", jsonString));
        }
        producer.flush();
        producer.close();
    }
