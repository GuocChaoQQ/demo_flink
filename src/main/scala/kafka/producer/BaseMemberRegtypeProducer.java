...
// 注册网站类型
    public static void main(String[] args) {
        //kafka-topics --zookeeper node47:2181 --create --replication-factor 2 -partitions 1 --topic test_regtype
        ...
        for (int i = 0; i < 1000000; i++) {
            ...
            producer.send(new ProducerRecord<String, String>("test_regtype", jsonString));
        }
        producer.flush();
        producer.close();
    }
